...
sudo add-apt-repository 'deb [arch=amd64] http://sgp1.mirrors.digitalocean.com/mariadb/repo/10.3/ubuntu/ bionic main' -y
# Update list of available packages
